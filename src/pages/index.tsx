  ...
  return (
    <>
      <div className="max-w-[500px] m-auto p-5">
        <h1 className="font-bold text-center text-2xl0">Sendgrid Test</h1>
        <div className="flex flex-col justify-start ">
          ...
          <button className="bg-blue-950 text-white font-semibold text-center w-full my-2 p-2 rounded-md">Send</button>
        </div>
      </div>
    </>
  );
